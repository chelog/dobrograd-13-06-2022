function REN.GTA4ColorTable(Col1,Col2,Col3)
...
Cols[134] = Color(245,180,0)		-- 134 SuperD yellow
Cols[135] = Color(5,5,5)				-- 135 black
Cols[136] = Color(189,149,75)			-- 136 Gold

return Cols[Col1],Cols[Col2],Cols[Col3] end