...
if CLIENT then
	...
	function ENT:Draw()
		...
		draw.SimpleText( L.price_for_liter, 'simfphys_gaspump_note', 0, 65, Color( 238, 238, 238, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )

		draw.SimpleText( L.diesel, 'simfphys_gaspump', 0, -60, Color(255,255,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP )
