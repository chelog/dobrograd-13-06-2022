...
ENT.PrintName = L.pingaz -- dont change anything here except for this name
...
ENT.DrugDescription = L.description_pingaz -- its description, remember to use newline (/n) to make multiple lines
