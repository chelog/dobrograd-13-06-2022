...
ENT.PrintName = L.drugbooze -- dont change anything here except for this name
...
ENT.DrugTime = 240 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(55, 55, 255) -- the colour of the title text
ENT.DrugDescription = L.description_drugbooze -- its description, remember to use newline (/n) to make multiple lines
