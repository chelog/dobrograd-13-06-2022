...
ENT.PrintName = L.drugbooze2 -- dont change anything here except for this name
...
ENT.DrugTime = 480 -- how much effect duration it gives you, effect duration can stack with multiple doses
-- clientside only
ENT.DrugColor = Color(85, 85, 255) -- the colour of the title text
ENT.DrugDescription = L.description_drugbooze2 -- its description, remember to use newline (/n) to make multiple lines
