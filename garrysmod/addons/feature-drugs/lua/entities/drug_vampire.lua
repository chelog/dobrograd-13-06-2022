...
ENT.PrintName = L.vampire -- dont change anything here except for this name
...
ENT.DrugDescription = L.description_vampire -- its description, remember to use newline (/n) to make multiple lines
