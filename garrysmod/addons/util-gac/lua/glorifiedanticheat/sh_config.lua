...
--[[ ADMIN PERMISSION SETTINGS ]]--
	gAC.config.ADMIN_MESSAGE_USERGROUPS = { "admin", "sadmin", "superadmin", "dev", "founder" } -- Set all the usergroups who can see admin messages here.
	gAC.config.ADMIN_MESSAGE_PING = "garrysmod/content_downloaded.wav"
	gAC.config.UNBAN_USERGROUPS = { "sadmin", "superadmin", "dev", "founder" } -- Set all the usergroups who can unban players here.
	gAC.config.SYNTAX = "AC: " -- Syntax for messages.
